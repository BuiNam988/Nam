   ...
   <div class="row content">
       <div class="col-sm-3 sidenav">
         <div class="panel panel-primary">
          <div class="panel-heading">Robot Armen</div>
          <div class="panel-body">
            <form action="handling.php" method="post" enctype="MULTIPLE/form-data">
              <div class="form-group">
                <label for="email">Robos Gao</label>
                <input type="text" name="fullname" class="form-control">
              </div>
              <div class="form-group">
                <label for="pwd">Batmen</label>
                  <td><input type="text" name="email" class="form-control"></td>
              </div>
              <div class="form-group">
                <label for="pwd">HEroku</label>
      ...
      <div class="col-sm-9">
          <div class="panel panel-primary">
            <div class="panel-heading">Company ATN</div>
            <div class="panel-body">
